...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-8 font-serif">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm">
            ...
            customers. Stay connected with us for updates and offers.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/add_data" className="hover:text-white">
                AddData
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="mb-4">
            <input
              ...
              className="w-full p-2 rounded-lg bg-gray-800 text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              type="submit"
          ...
          <div className="flex space-x-4">
            <a
              target="_blank"
              href="https://www.facebook.com/profile.php?id=100083618973410"
            ...
            <a
            target="_blank"
              href="https://www.linkedin.com/in/aaditya-kumar-b97817349/"
              className="p-2 bg-gray-800 rounded-full hover:bg-blue-600"
            >
              <FaLinkedinIn />
            </a>
      ...
      <div className="mt-8 border-t border-gray-700 pt-4 text-center text-sm">
        <p>
          &copy; {new Date().getFullYear()} Aaditya Kumar. All rights reserved.
        </p>
      </div>
    </footer>
  );
